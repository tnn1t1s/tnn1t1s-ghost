...
(RimClap gained TUNE, Toms gained per-voice TUNE/DECAY, Tr909Ctrl dropped
...
GHOST_909 = {"Kck", "Snr", "ChhOhh", "RimClap", "Toms", "CrashRide", "Tr909Ctrl"}
RESET_PARAMS = {"RimClap", "Toms", "Tr909Ctrl"}   # param surface changed -> use new defaults
